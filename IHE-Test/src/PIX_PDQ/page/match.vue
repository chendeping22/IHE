<template>
	<div v-loading="loading" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading">
		<el-form ref="checkForm" :model="checkForm" status-icon :rules="checkRules" label-width="100px" style="padding:0 20px">
			<el-row>
				<el-card class="box-card" style="border-right: none;">
					...
					<div class="checkBox">
						...
						<el-row class="save-btn">
							<el-button type="primary" @click="updateChecked('saveBtn')">保存</el-button>
						</el-row>
					</div>
				</el-card>
			</el-row>
				...
				Apis.match.query()
					.then(res => {
						...
						if(res.status === 200) {
							...
							//								type: 'success',
							//							});
							console.log(typeof res.data !== undefined, typeof res.data.data !== undefined)
