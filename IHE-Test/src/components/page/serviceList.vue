<template>
  <div class="form-wrap" size="medium">
        ...
        <template>
          ...
          <el-table :data="tableData" border style="width: 100%">
            ...
            <el-table-column prop="regLibraryHttps" label="注册库-http" width="200">
            </el-table-column>
...
export default {
  ...
  methods: {
    ...
    openKView(){
       let str ='KView:////info=studyuid=1.2.826.0.1.3680043.2.461.9781923.2589951579<<|>>userid=666666<<|>>pacssvrip=192.168.171.229<<|>>pacssvrport=7008<<|>>pacssvrip1=<<|>>pacssvrport1=<<|>>security=1';
